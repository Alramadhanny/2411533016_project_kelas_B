...
public class Main {
    public static void main(String[] args) {
        ...
        Mobil mobil = new Mobil("Toyota", "Avanza", 2021, "Matic");
        ...
        bus.fiturBus();
        bus.setJadwal("Jakarta – Bandung", "08:00");
        bus.tampilkanInfoJadwalBus();
        
        System.out.println();
        Pesawat pesawat = new Pesawat("Garuda", "Boeing 737", 100, "Garuda Indonesia", "Domestik");
